...
const privacySections = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "BOOST verwendet keine E-Mail-Adresse der Schüler/innen. Die Anmeldung erfolgt über einen Code, der über Sportlehrer weitergegeben wird und einer Schule und Klasse zugeordnet ist.",
      ...
      "Soweit Daten aus Apple Health, Google Fit, Google Health Connect oder ähnlichen Diensten eingebunden werden, erfolgt dies nur, wenn die entsprechende Berechtigung am Gerät erteilt wurde. Die Berechtigung kann jederzeit in den Geräteeinstellungen widerrufen werden.",
