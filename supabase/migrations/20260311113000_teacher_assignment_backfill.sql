-- Backfill migration: ensure teacher-student assignment infrastructure exists.
...
DROP POLICY IF EXISTS "Teachers can view own assignments" ON public.teacher_student_assignments;
