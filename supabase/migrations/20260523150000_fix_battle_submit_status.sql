-- Allow submitting battle results when status is 'accepted' (camera-direct flow bypasses ready phase)
-- Previously required status = 'in_progress'; now accepts 'accepted' too and auto-upgrades it.
