-- Klassenranking uses SUM of actual student points (same value as "Meine Klasse").
-- Covers both the new students-table system (class_id FK) and the old profiles text fields.
